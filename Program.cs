...
namespace jeu_du_pendu
{
    class Program
    {
        ...
        static bool DemanderDeRejouer()
        {
            ...
            {
                Console.WriteLine("Erreur : Vous devez répondre avec o/O ou n/N.");
        ...
        static void Main(string[] args)
        {
            ...
            else
            {
                while(true)
                {
                    ...
                    string mot = mots[i].Trim().ToUpper(); // Rappel : trim sert à supprimer les espaces
                    DevinerMot(mot);
